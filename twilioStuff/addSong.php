...
try {
	...
	$isThere=file_get_contents("https://songbox.firebaseio.com/songs/".$id."/.json");
	if($isThere=="null") {
		$highestPriority=intval(file_get_contents("https://songbox.firebaseio.com/highestPriority/.json"));
		...
		if(file_get_contents("https://songbox.firebaseio.com/songs/".$id."/".$number."/.json")=="null") {
			$currPriority=intval(file_get_contents("https://songbox.firebaseio.com/songs/".$id."/.priority/.json"));
