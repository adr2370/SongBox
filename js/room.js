var player=null;
var firebase = new Firebase('https://songbox.firebaseio.com/rooms/'+room+'/');
	...
	currentdb.once('value', function(dataSnapshot) {
		...
		if(player==null) {
			player=new YT.Player('youtube', {
				...
				width: '640',
				videoId: id,
				playerVars: { autoplay:1, enablejsapi:1, modestbranding:1, rel:0, iv_load_policy:3, volume:50, start:0 },
				events: {
